...
Hard constraints:
  ...
  - Canonical identifiers (directory names, package names, environment variables, resource IDs) come from D-03 (docs/UD_CRU_POC_D03_Development_Guide_v1.0.docx) or where D-03 delegates to D-01 or D-02. Do not invent names. If D-03 lists 9 apps and 6 libs with specific names, create them with those exact names, no renaming, no substitutions, no omissions, no additions. If D-03 is silent on a name you need, stop and mark the task blocked rather than guessing.
